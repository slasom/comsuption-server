 ...
 * Variable
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-01-24T12:57:09.429Z[GMT]")public class Variable   {
  ...
  public Variable varName(String varName) {
  ...
  public Variable values(List<Float> values) {
    this.values = values;
    return this;
  }

  public Variable addValuesItem(Float valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.varName, variable.varName) &&
        Objects.equals(this.values, variable.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(varName, values);
  }
